...
export default function ChartOfAccountsTable() {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            {/* Main Content */}
            <div className="p-2">
                <div className="sticky top-0 bg-white flex items-center justify-between gap-4 border-b-2 mt-1 shadow-md p-2 z-20">
                                            ...
                                            <TableRow key={account.code}>
                                                ...
                                                <TableCell className="text-center">
                                                    <Switch
                                                        ...
                                                        onCheckedChange={(checked) => handleSwitchChange(account.code, checked)}
