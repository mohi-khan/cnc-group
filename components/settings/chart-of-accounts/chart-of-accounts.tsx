...
const accountTypes = ['Equity', 'Assets', 'Liability', 'Income', 'Expenses']
...
export default function ChartOfAccountsTable() {
    ...
    const fetchAccounts = async () => {
      try {
        const response = await fetch(
          'http://localhost:4000/api/chart-of-accounts/get-all-coa'
        )
        if (!response.ok) {
  ...
  const handleAddAccount = async (data: any) => {
    try {
      ...
      const response = await fetch(
        'http://localhost:4000/api/chart-of-accounts/create-coa',
        {
          method: 'POST',
          headers: {
...
// const accountTypes = ['Equity', 'Assets', 'Liability', 'Income', 'Expenses']
// const currencyItems = ['BDT', 'USD', 'EUR']
// const parentIds = ['10010', '20100', '30120', '785222']
...
//                   <Select>
//                     <SelectTrigger>
//                       <SelectValue placeholder="Enter currency ID" />
//                     </SelectTrigger>
//                     <SelectContent>
//                       {currencyItems.map((type) => (
//                         <SelectItem key={type} value={type.toLowerCase()}>
//                           {type}
//                         </SelectItem>
//                       ))}
...
//       const response = await fetch(
//         'http://localhost:4000/api/chart-of-accounts/create',
//         {
//           method: 'POST',
//           headers: {
//             'Content-Type': 'application/json',
