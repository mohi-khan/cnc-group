...
// interface AccountNode extends AccountsHead {
...
//   const [groups, setGroups] = React.useState<CodeGroup[]>([]) // Now dynamic
...
//   // New state for collapsible tree
//   const [accountTree, setAccountTree] = React.useState<AccountNode[]>([])
//   const [flattenedAccounts, setFlattenedAccounts] = React.useState<AccountNode[]>([])
//   const [expandedNodes, setExpandedNodes] = React.useState<Set<string>>(new Set())

//   const totalPages = Math.ceil(flattenedAccounts.length / itemsPerPage)

//   // Function to build account tree structure
//   const buildAccountTree = React.useCallback((accountsData: AccountsHead[]): AccountNode[] => {
...
//         ...account,
//         children: [],
//         isExpanded: expandedNodes.has(account.code),
//         level: 0
//       })
//     })
...
//         // Try different parent code lengths
//         for (let i = account.code.length - 1; i > 0; i--) {
//           const potentialParent = account.code.substring(0, i)
...
//     // Sort nodes by code at each level
...
//   // Function to flatten tree for display
//   const flattenTree = React.useCallback((nodes: AccountNode[]): AccountNode[] => {
...
//   // Build tree structure when accounts or expanded nodes change
//   React.useEffect(() => {
//     if (accounts.length > 0) {
//       const tree = buildAccountTree(accounts)
//       setAccountTree(tree)
//     }
//   }, [accounts, buildAccountTree])

//   // Update flattened accounts when tree or filters change
//   React.useEffect(() => {
...
//     // Build tree with filtered accounts
//     const tree = buildAccountTree(filtered)
//     const flattened = flattenTree(tree)
//     setFlattenedAccounts(flattened)
//   }, [searchTerm, selectedTypes, activeAccountOnly, selectedCode, accounts, accountTree, flattenTree, buildAccountTree])
...
//             }
//           }}
//           title={`Code ${group.code}`} // Show account name on hover
//         >
...
//               </div>
//             )}
//             {/* Table header and data with collapsible rows */}
...
//                           key={account.code}
//                           className={cn(
//                             account.level === 0 && "bg-slate-100 border-b-2 border-slate-300 font-bold",
//                             account.level === 1 && "bg-white",
//                             account.level === 2 && "bg-gray-50",
//                             account.level >= 3 && "bg-gray-100"
//                           )}
//                         >
//                           <TableCell>
//                             <div
...
//                             >
//                               {(account.children.length > 0 || account.level === 0) && (
//                                 <Button
//                                   variant="ghost"
//                                   size="sm"
...
//                               )}
//                               <span className={cn(
//                                 account.level === 0 && "font-bold text-lg uppercase tracking-wide",
//                                 (account.children.length > 0 && account.level > 0) && "font-semibold"
//                               )}>
//                                 {account.level === 0 ? `${account.name}` : account.code}
//                               </span>
//                             </div>
//                           </TableCell>
//                           <TableCell className={cn(
//                             account.level === 0 && "font-bold text-lg",
//                             (account.children.length > 0 && account.level > 0) && "font-semibold"
//                           )}>
//                             {account.level === 0 ? '' : account.name}
//                           </TableCell>
//                           <TableCell>
//                             {account.level === 0 ? '' : account.parentName}
//                           </TableCell>
//                           <TableCell>
//                             {account.level === 0 ? '' : (
...
//                           key={account.code}
//                           className={cn(
//                             account.level > 0 && "bg-muted/30",
//                             account.level === 1 && "pl-4",
//                             account.level === 2 && "pl-8",
//                             account.level >= 3 && "pl-12"
//                           )}
//                         >
//                           <TableCell>
//                             <div
...
//                               )}
//                               <span className={cn(
//                                 account.children.length > 0 && "font-semibold"
//                               )}>
//                                 {account.code}
//                               </span>
//                             </div>
