...
//     handleSubmit(data, resetForm)
//   } else {
//     // 🧩 Fix: Convert string IDs to numbers before sending
//     const payload: JournalEditWithDetails = {
//       ...(initialData as JournalEditWithDetails),
//       ...data,
//       journalEntry: {
...
//           ...baseDetail,
//           ...detail,
//           // ✅ Force numeric conversion; never allow null
//           accountId: detail.accountId
//             ? Number(detail.accountId)
//             : Number(baseDetail.accountId || 0),
//       resPartnerId: Number(detail.resPartnerId) || 0, // convert to number
//           costCenterId: detail.costCenterId
//             ? Number(detail.costCenterId)
//             : Number(baseDetail.costCenterId || 0),
//           departmentId: detail.departmentId
//             ? Number(detail.departmentId)
//             : Number(baseDetail.departmentId || 0),
//         }
//       }),
//     }
...
//   // Default values, safely convert all IDs to numbers
//   const defaultValues = useMemo(
//     () =>
//       initialData
//         ? {
...
//               resPartnerId: Number(detail.resPartnerId) || 0,
//               costCenterId: Number(detail.costCenterId) || 0,
...
//             0
//           ) || 0
//         form.setValue('journalEntry.amountTotal', Math.max(totalDebit, totalCredit))
//       }
//     })
//     return () => subscription.unsubscribe()
//   }, [form])
...
//             resPartnerId: Number(detail.resPartnerId || baseDetail.resPartnerId || 0),
//             costCenterId: Number(detail.costCenterId || baseDetail.costCenterId || 0),
//             departmentId: Number(detail.departmentId || baseDetail.departmentId || 0),
//           }
//         }),
//       }
