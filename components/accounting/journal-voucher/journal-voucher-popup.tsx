...
// ─── Props ─────────────────────────────────────────────────────────────────────
// ✅ create সংক্রান্ত সব props সরানো হয়েছে (lastUsedValues, showLastUsedBanner, onClearLastUsed)
// ✅ এই popup এখন শুধুমাত্র EDIT এর জন্য ব্যবহার হবে
interface JournalVoucherPopupProps {
  ...
  initialData: JournalEntryWithDetails | JournalEditWithDetails  // ✅ edit এ required
  isEdit: true  // ✅ এই popup শুধু edit mode এ থাকবে
  onClose?: () => void
}

/** Fallback default for form reset only — edit mode এ initialData থেকে আসে */
const staticDefault = (): JournalEntryWithDetails => ({
  journalEntry: {
...
export function JournalVoucherPopup({
  ...
  // ─── Edit mode: initialData থেকে defaultValues বানাও ────────────────────────
  ...
  const resetForm = useCallback(() => {
    form.reset(staticDefault())
  }, [form])

  // ─── Dialog খুললে form reset করো initialData দিয়ে ────────────────────────────
  useEffect(() => {
    if (isOpen) {
  ...
  // ✅ শুধু Edit Dialog — ADD বাটন বা create UI নেই
  return (
      ...
      >
        <DialogHeader>
          <div>
            ...
            <DialogDescription>
              Update the details for the journal voucher here. Click save when
              you are done.
            </DialogDescription>
          </div>
        </DialogHeader>
