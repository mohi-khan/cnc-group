...
//   // Watch the selected company ID for bank account filtering
...
//       // Update amounts based on form type - if debit, amounts go to debit field, credit becomes 0
...
//   useEffect(() => {
//     if (settings && formState.formType && fields.length > 0) {
//       const totalAmount = form.getValues('journalEntry.amountTotal') || 0
//       const currentDetails = form.getValues('journalDetails') || []

//       // Check if we already have a settings entry
//       const hasSettingsEntry = currentDetails.some(
//         (detail: any) => detail.accountId === settings
//       )

//       if (!hasSettingsEntry && totalAmount > 0) {
//         // Add the settings entry
//         const newDetail = {
//           voucherId: 0,
//           accountId: settings, // Use settings accountId
//           costCenterId: null,
//           departmentId: null,
//           debit: formState.formType === 'Credit' ? totalAmount : 0, // Opposite of form type
//           credit: formState.formType === 'Debit' ? totalAmount : 0, // Opposite of form type
//           analyticTags: null,
//           taxId: null,
//           resPartnerId: null,
//           notes: '',
...
//       }
//     }
//   }, [settings, formState.formType, form, append, fields.length])
...
//                                     id: field.value.toString(),
//                                     name:
//                                       `${filteredBankAccounts.find((a) => a.id === field.value)?.bankName} - ${
//                                         filteredBankAccounts.find(
//                                           (a) => a.id === field.value
//                                         )?.accountName
//                                       } - ${filteredBankAccounts.find((a) => a.id === field.value)?.accountNumber}` ||
//                                       '',
//                                   }
//                                 : null
//                             }
//                             onChange={(value) => {
//                               const bankAccountId = value
//                                 ? Number.parseInt(value.id, 10)
//                                 : null
//                               field.onChange(bankAccountId)

//                               // Update formState with selected bank account
//                               if (bankAccountId) {
...
//                   <FormField
//                     control={form.control}
//                     name={`journalDetails.${index}.${formState.formType === 'Debit' ? 'debit' : 'credit'}`}
//                     render={({ field }) => (
//                       <FormItem>
//                         <FormControl>
//                           <Input
...
//           // Calculate the sum of all existing amounts
//           const currentField =
//             formState.formType === 'Debit' ? 'debit' : 'credit'
//           const usedAmount = currentDetails.reduce(
//             (sum: number, detail: Record<string, number>) =>
//               sum + (detail[currentField] || 0),
//             0
...
//             costCenterId: null,
//             departmentId: null,
//             debit: formState.formType === 'Debit' ? remainingAmount : 0,
//             credit: formState.formType === 'Credit' ? remainingAmount : 0,
//             analyticTags: null,
//             taxId: null,
//             resPartnerId: null,
//             notes: '',
//             createdBy: 0,
//             bankaccountid: null, // Initialize with null, user will select from dropdown
//           })
//         }}
//       >
//         Add Another
