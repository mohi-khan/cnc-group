              ...
              value={
                companyId
                  ? {
                      ...
                      name:
                        companies.find((c) => (c.companyId || c.id) === companyId)
                          ?.companyName ||
                        companies.find((c) => (c.companyId || c.id) === companyId)
                          ?.name ||
                        '',
              ...
              <TableHeader>
                ...
                <TableRow>
                  ...
                  <TableHead className="border border-gray-300 bg-gray-100 text-right font-medium">
                    Opening as on <br /> 01.07.xxxx
                  </TableHead>
                  <TableHead className="border border-gray-300 bg-gray-100 text-right font-medium">
                    Addition
                  </TableHead>
                  <TableHead className="border border-gray-300 bg-gray-100 text-right font-medium">
                    Total as on <br /> 31.12.xxxx
                  </TableHead>
                  <TableHead className="border border-gray-300 bg-gray-100 text-right font-medium">
                    Rate %
                  </TableHead>
              ...
              <TableBody>
                {reportData.map((asset, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell className="border border-gray-300 text-right">
                      {formatIndianNumber(Number(asset.opening_balance || 0))}
                    </TableCell>
                    <TableCell className="border border-gray-300 text-right">
                      {Number.parseFloat(asset.addition_during_period) === 0
                        ? '-'
                        : formatIndianNumber(Number(asset.addition_during_period || 0))}
                    </TableCell>
                    <TableCell className="border border-gray-300 text-right">
                      {formatIndianNumber(Number(asset.closing_balance || 0))}
                    </TableCell>
                    <TableCell className="border border-gray-300 text-right">
                      {asset.rate}
                    </TableCell>
                    <TableCell className="border border-gray-300 text-right">
                      {formatIndianNumber(Number(asset.dep_opening || 0))}
                    </TableCell>
                    <TableCell className="border border-gray-300 text-right text-purple-700 font-medium">
                      {formatIndianNumber(Number(asset.dep_during_period || 0))}
                    </TableCell>
                    <TableCell className="border border-gray-300 text-right">
                      {formatIndianNumber(Number(asset.dep_closing || 0))}
                    </TableCell>
                    <TableCell className="border border-gray-300 text-right">
                      {formatIndianNumber(Number(asset.written_down_value || 0))}
                    </TableCell>
                  </TableRow>
                ))}
                ...
                {reportData.length > 0 && (
                  <TableRow className="bg-gray-50 font-bold">
                    ...
                    <TableCell className="border border-gray-300 text-right">
                      {formatIndianNumber(calculateTotal(reportData, 'opening_balance'))}
                    </TableCell>
                    <TableCell className="border border-gray-300 text-right">
                      {formatIndianNumber(calculateTotal(reportData, 'addition_during_period'))}
                    </TableCell>
                    <TableCell className="border border-gray-300 text-right">
                      {formatIndianNumber(calculateTotal(reportData, 'closing_balance'))}
                    </TableCell>
                    <TableCell className="border border-gray-300"></TableCell>
                    <TableCell className="border border-gray-300 text-right">
                      {formatIndianNumber(calculateTotal(reportData, 'dep_opening'))}
                    </TableCell>
                    <TableCell className="border border-gray-300 text-right text-purple-700">
                      {formatIndianNumber(calculateTotal(reportData, 'dep_during_period'))}
                    </TableCell>
                    <TableCell className="border border-gray-300 text-right">
                      {formatIndianNumber(calculateTotal(reportData, 'dep_closing'))}
                    </TableCell>
                    <TableCell className="border border-gray-300 text-right">
                      {formatIndianNumber(calculateTotal(reportData, 'written_down_value'))}
                    </TableCell>
                  </TableRow>
                )}
              </TableBody>
