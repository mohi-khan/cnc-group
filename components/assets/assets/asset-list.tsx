          ...
          {paginatedAssets.map((assets) => {
            ...
            return (
              <TableRow key={assets.id}>
                ...
                <TableCell>{formatIndianNumber(Number(assets.currentValue || 0))}</TableCell>
                <TableCell>{assets.purchaseDate}</TableCell>
                <TableCell>{formatIndianNumber(Number(assets.purchaseValue || 0))}</TableCell>
                <TableCell>{formatIndianNumber(Number(assets.salvageValue || 0))}</TableCell>
