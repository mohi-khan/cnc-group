...
//   const [validationError, setValidationError] = useState<string | null>(null)
//   const [amountError, setAmountError] = useState<string | null>(null)
//   const [notes, setNotes] = useState<string>('') // store user input
...
//           journalType: 'Bank Voucher dfsfsf',
...
//         voucherData.date || new Date().toISOString().split('T')[0]
//       )
//       form.setValue('journalEntry.journalType', 'Bank Voucher')
...
//   // Sort data to show debit rows first
//   const confirmReverseVoucher = async () => {
//     setIsAlertDialogOpen(false)
//     const createdId = userId ?? 0
//     const voucherId = data?.[0].voucherno
...
//     // Log each item's bank account info
...
//         bankaccountid: item.bankaccountid, // ✅ Use lowercase 'id'
//         debit: item.debit,
//         credit: item.credit,
//       })
//     })
...
//     if (!data) return []
//     return [...data].sort((a, b) => {
//       // If a has debit and b doesn't, a comes first
//       if (a.debit > 0 && b.debit === 0) return -1
//       // If b has debit and a doesn't, b comes first
//       if (b.debit > 0 && a.debit === 0) return 1
