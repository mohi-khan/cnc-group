...
//     // Calculate total amount from all voucher items
//     const totalAmount = data.reduce((sum, item) => {
//       return sum + (item.debit || 0) + (item.credit || 0)
//     }, 0)

//     // Pre-populate the bank voucher form with complete voucher data
//     form.reset({
//       journalEntry: {
//         date: data[0].date || new Date().toISOString().split('T')[0],
//         journalType: 'Bank Voucher',
//         companyId:  data?.companyname || 0,
//         locationId:  0,
//         currencyId:  1,
//         exchangeRate:  1,
//         amountTotal: totalAmount,
//         payTo: data[0].payTo || data[0].partner || '',
//         notes: `Bank Voucher for ${data[0].journaltype} - ${data[0].voucherno}`,
//         createdBy: userData?.userId || 0,
//       },
//       journalDetails: data.map((item, index) => ({
...
//         analyticTags: null,
//         taxId: null,
//         resPartnerId: item.partnerid || null,
//         notes: item.notes || `Line ${index + 1} from ${data[0].voucherno}`,
//         createdBy: userData?.userId || 0,
//       })),
//     })
...
//         locationId: data?.[0]?.locationid || 0,
...
//               <DialogHeader>
//                 <DialogTitle>
//                   Create Bank Voucher - {data?.[0]?.voucherno}
//                 </DialogTitle>
//               </DialogHeader>
//               <div className="mt-4">
//                 <Form {...form}>
...
//                       isFromInvoice={true}
//                       invoicePartnerName={data?.[0]?.partner || ''}
//                     />
//                     <BankVoucherSubmit
//                       form={form}
//                       onSubmit={onSubmit}
