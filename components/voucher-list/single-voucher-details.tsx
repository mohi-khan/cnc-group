...
//   getResPartnersBySearch,
// } from '@/api/common-shared-api'
// import BankAccounts from '../settings/bank-accounts/bank-accounts'
...
//   // Enhanced form population effect that waits for all data to be loaded
//   useEffect(() => {
//     if (
//       isBankVoucherDialogOpen &&
//       data &&
...
//       userData &&
//       !formState.selectedBankAccount // Only run if bank account is not already selected
//     ) {
...
//             acc.displayName?.toLowerCase().trim() ===
//               accountName.toLowerCase().trim()
//         )
//       }
...
//         return formState.costCenters.find(
//           (cc) =>
//             cc.name?.toLowerCase().trim() ===
//             costCenterName.toLowerCase().trim()
//         )
//       }
...
//         return formState.partners.find(
//           (p) =>
...
//         return formState.bankAccounts.find(
//           (bank) =>
//             bank.name?.toLowerCase().trim() ===
//             bankAccountName.toLowerCase().trim()
//         )
//       }
...
//       // Find the bank account from the voucher data
//       const selectedBankAccountFromData = getBankAccountByName(
//         data[0]?.bankaccount || ''
//       )
...
//       // Update form state with selected bank account FIRST to prevent re-runs
//       if (selectedBankAccountFromData) {
//         setFormState((prevState) => ({
//           ...prevState,
//           selectedBankAccount: selectedBankAccountFromData,
//           status: 'Draft',
//           formType: 'Debit',
//         }))
//       }
...
//         // Set journal details individually
//         mappedJournalDetails.forEach((detail, index) => {
//           form.setValue(`journalDetails.${index}.accountId`, detail.accountId)
//           form.setValue(
//             `journalDetails.${index}.costCenterId`,
...
//   }, [
//     isBankVoucherDialogOpen,
//     data?.[0]?.id, // Only depend on the voucher ID, not the entire data array
//     isFormDataLoaded,
...
//     userData?.userId,
//     formState.selectedBankAccount, // Include this to prevent re-runs when already set
//   ])
...
//       toast({
//         title: 'Please wait',
//         description: 'Form data is still loading...',
//         variant: 'default',
//       })
//       return
//     }
...
//     setFormState((prevState) => ({
//       ...prevState,
//       selectedBankAccount: null, // Reset this to allow form population
//       status: 'Draft',
//       formType: 'Debit',
//     }))

//     console.log('Opening bank voucher dialog with data:', data)
//     setIsBankVoucherDialogOpen(true)
//   }, [data, isFormDataLoaded])
...
//           taxId: null,
//           resPartnerId: null,
//           bankaccountid: formState.selectedBankAccount?.bankAccountId || 0,
//           notes: updatedValues.journalEntry.notes || '',
//           createdBy: userData?.userId ?? 0,
//         },
//       ],
...
//                   size="sm"
//                   onClick={handleReceiptClick}
//                   disabled={!isFormDataLoaded}
//                 >
//                   <Pencil className="w-4 h-4 mr-2" />
//                   {!isFormDataLoaded ? 'Loading...' : 'New Bank Voucher'}
//                 </Button>
//               )}
//               <AlertDialog
//                 open={isAlertDialogOpen}
...
//                     {formState.selectedBankAccount?.name || 'None'}
//                   </p>
//                   <p>
//                     Bank Account from Data: {data[0]?.bankaccount || 'None'}
//                   </p>
//                   <p>Pay To: {form.watch('journalEntry.payTo')}</p>
//                   <p>Form Data Loaded: {isFormDataLoaded ? 'Yes' : 'No'}</p>
//                 </div>
