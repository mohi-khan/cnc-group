...
// import type { BankAccount, FdrCreateType, FdrGetType } from '@/utils/type'
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <CustomCombobox
                      items={bankAccounts.map((account, index) => ({
                        id: `${account.bankName}-${index}`,
                      ...
                      value={
                        field.value
                          ? {
                              ...
                              name:
                                bankAccounts.find(
                                  (account) => account.bankName === field.value
