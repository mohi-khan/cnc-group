              ...
              <div className="flex flex-col gap-2">
                <div className="flex gap-4">
                  ...
                  <div className="text-right font-semibold w-32">
                    {formatIndianNumber(report.openingBalance.book)}
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="text-right">
                  ...
                  <div className="text-right font-semibold w-32">
                    {formatIndianNumber(report.openingBalance.bank)}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-4 flex flex-col gap-1">
              <div className="flex justify-between">
                ...
                <div className="w-32 text-right font-semibold">
                  {formatIndianNumber(Number(report.closingBalance.book))}
                </div>
              </div>
              <div className="flex justify-between">
                <div>Balance as per Bank Statement</div>
                <div className="w-32 text-right font-semibold">
                  {formatIndianNumber(Number(report.closingBalance.bank))}
                </div>
              </div>
              <div className="flex justify-between">
                <div>Difference</div>
