...
const IouList: React.FC<LoanListProps> = ({
  ...
  const filteredLoanData = useMemo(() => {
    ...
    return loanAllData.filter((loan) => {
      ...
      const fullLabel =
        `${employee.employeeName} ${employee.employeeId}`.toLowerCase()
      return fullLabel.includes(lower)
    })
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-9 pr-4 py-2 border rounded-md text-sm w-64 focus:outline-none focus:ring-2 focus:ring-ring"
            />
          </div>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="w-full h-[500px] overflow-auto border shadow-md">
          <Table className="min-w-full">
            <TableHeader className="sticky top-0 bg-slate-200 z-20">
              <TableRow>
                <TableHeadCell>
