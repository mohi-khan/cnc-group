...
export default function CashVoucher() {
  ...
  const handleSubmit = (isDraft: boolean) => {
    ...
    setDetailRows([{ id: 1, accountHead: '', particulars: '', costCenter: '', amount: '' }])
  }
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-6">
          ...
          <div className="space-y-2">
            ...
            <Select 
              ...
              onValueChange={(value) => handleInputChange('paymentReceipt', value)}
            >
              <SelectTrigger>
                ...
                <TableRow key={row.id}>
                  <TableCell>
                    <Input 
                      ...
                      onChange={(e) => handleDetailChange(row.id, 'accountHead', e.target.value)}
                    />
                  </TableCell>
                  <TableCell>
                    <Input 
                      ...
                      onChange={(e) => handleDetailChange(row.id, 'particulars', e.target.value)}
                    />
                  </TableCell>
                  <TableCell>
                    <Input 
                      ...
                      onChange={(e) => handleDetailChange(row.id, 'costCenter', e.target.value)}
                    />
                  </TableCell>
                  <TableCell>
                    <Input 
                      type="number" 
                      value={row.amount}
                      onChange={(e) => handleDetailChange(row.id, 'amount', e.target.value)}
                    />
                  </TableCell>
                  <TableCell>
                    <Button 
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          <div className="space-y-2">
            ...
            <Input 
              ...
              id="total" 
              readOnly 
              value={detailRows.reduce((sum, row) => sum + Number(row.amount || 0), 0)}
            />
          </div>
          <div className="space-y-2">
