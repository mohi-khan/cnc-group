...
//   // Debug logging
//   useEffect(() => {
//     console.log('🎯 CashVoucherDetails Debug:')
//     console.log('Selected Company ID:', selectedCompanyId)
//     console.log('Is Company Selected:', isCompanySelected)
//     console.log('Filtered Chart of Accounts received:', filteredChartOfAccounts)
//     console.log('Total accounts available:', filteredChartOfAccounts.length)
//   }, [selectedCompanyId, isCompanySelected, filteredChartOfAccounts])
...
//             <TableHead>Cost Center</TableHead>
//             <TableHead>Unit</TableHead>
//             <TableHead>Employee</TableHead> {/* Add this */}
//             <TableHead>Partner Name</TableHead>
//             <TableHead>Remarks</TableHead>
//             <TableHead>Amount</TableHead>
//             <TableHead>Action</TableHead>
