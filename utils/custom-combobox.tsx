...
//   // Handler to open the dropdown when clicking anywhere in the container.
//   const handleContainerMouseDown = () => {
//     if (inputRef.current) {
//       // Focus the input element.
//       inputRef.current.focus()

//       // Dispatch an ArrowDown key event to simulate pressing ArrowDown,
//       // which triggers Headless UI to open the dropdown.
...
//   return (
//     // Use onMouseDown on the outer container
